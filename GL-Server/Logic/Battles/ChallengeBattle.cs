namespace GL.Servers.CoC.Logic.Battles
{
    ...
    public class ChallengeBattle : IBattle
    {
        /// <summary>
        /// The base.
        /// </summary>
        ...
        /// <summary>
        /// Initializes new instance of the <see cref="ChallengeBattle"/>
        /// </summary>
        /// <param name="Level">The base.</param>
        /// <param name="Attacker">The attacker.</param>
        /// <param name="Defender">The defender.</param>
        public ChallengeBattle(Objects Level, Player Attacker, Player Defender)
        {
            this.Level    = Level;
