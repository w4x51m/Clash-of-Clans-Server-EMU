...
namespace GL.Servers.CoC.Logic
{
    ...
    public class Player
    {
        ...
        [JsonProperty("lvl")]               internal int Level              = Random.Next(12, 25);
        [JsonProperty("xp")]                internal int Experience              = Random.Next(360, 540);

        [JsonProperty("league_type")]       internal int League;
        [JsonProperty("shield")]             internal int Shield;
        [JsonProperty("guard")]             internal int Guard;
        [JsonProperty("score")]             internal int Score              = Random.Next(2460, 4973);
        [JsonProperty("duel_score")]        internal int DuelScore              = Random.Next(1460, 3110);
        [JsonProperty("legendary_score")]   internal int LegendaryScore              = 5600;
        ...
        [JsonProperty("wins")]              internal int Wins              = Random.Next(200, 250);
        [JsonProperty("loses")]             internal int Loses              = Random.Next(5, 15);
        [JsonProperty("t_wins")]            internal int TotalWins;
        [JsonProperty("defense_wins")]      internal int DefenseWins              = Random.Next(80, 65);
        [JsonProperty("t_defense_wins")]    internal int TotalDefenseWins;
        ...
        [JsonProperty("treasury_gold")]     internal int TreasuryGold              = Random.Next(1600000, 2400000);
        [JsonProperty("treasury_elixir")]   internal int TreasuryElixir              = Random.Next(1600000, 240000);
        [JsonProperty("treasury_d_elixir")] internal int TreasuryDarkElixir              = Random.Next(56000, 89000);

        [JsonProperty("name_setted")]       internal bool NameSetted;
        [JsonProperty("name_changed")]      internal bool NameChanged            = true;
